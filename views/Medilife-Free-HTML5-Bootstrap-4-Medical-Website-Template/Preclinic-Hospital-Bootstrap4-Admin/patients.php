            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li>
                            <a href="../index.php"><i class="fa fa-calendar"></i> <span>rendez-vous</span></a>
                        </li>
                        <li>
                            <a href="patientsp.php"><i class="fa fa-calendar"></i> <span>prestation</span></a>
                        </li>
                        <li>
							...
							<table class="table table-border table-striped custom-table datatable mb-0">
								...
								<tbody>
                                  ...
                                  <?php foreach ($cons as $c) { ?>
									...
									<tr>
 										<td><img width="28" height="28" src="assets/img/user.jpg" class="rounded-circle m-r-5" alt=""> <?= $c['prenom'] ?><?php echo"  "?> <?= $c['nom'] ?></td>
