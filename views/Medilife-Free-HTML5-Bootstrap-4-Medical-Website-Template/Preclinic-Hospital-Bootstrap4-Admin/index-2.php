            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li>
                            <a href="patientsp.php"><i class="fa fa-wheelchair"></i> <span>Prestation</span></a>
                        </li>
                        <li>
                            <a href="../index.php"><i class="fa fa-wheelchair"></i> <span>rendez-vous</span></a>
                        </li>
					...
					<div class="col-12 col-md-6 col-lg-8 col-xl-8">
						<div class="card">
							<div class="card-header">
								<h4 class="card-title d-inline-block">Consultatons du jour</h4> <a href="appointments.html" class="btn btn-primary float-right">View all</a>
							</div>
                                    ...
                                    <li>
                                        <div class="contact-cont">
                                            ...
                                            <div class="contact-info">
                                                <span class="contact-name text-ellipsis"><?=$c['nom'] ?></span>
                                             </div>
                                        </div>
                                    </li>
